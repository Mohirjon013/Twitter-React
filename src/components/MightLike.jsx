...
import Human1 from "../assets/images/human-imgs1.png"
import Human2 from "../assets/images/human-imgs2.png"
import { Context } from '../context/AuthContext'

function MightLike() {
  const {dark} = useContext(Context)
  return (
    <div className={`w-[373px] pt-[20px] px-[15px] bg-[#F7F9F9] rounded-[10px] ${dark && '!text-black'}`}>
